					...
					if (!FileUtils.getNotModifiedFiles().isEmpty()){
						...
						if (!FileUtils.getRenamedFileName().isEmpty()){
							...
							if (!KeystoreFile.getKeystorePath().isEmpty()){
								...
								String resignCommand = "jarsigner -sigalg SHA1withRSA -digestalg SHA1 -keystore " + KeystoreFile.getKeystorePath() + " " +  renamedFile + " " + FileUtils.getAliasName() + " -storepass " + FileUtils.getPswd();
